...
public class GatherCompanyInfo extends AsyncTask<Void, Void, Void> {
        private Context context;
        private ArrayList<Company> companyList;
        private ListView listView;
        private ListAdapter adapter;
        GatherCompanyInfo(ArrayList<Company> companyList,Context context,ListAdapter adapter, ListView listView) {

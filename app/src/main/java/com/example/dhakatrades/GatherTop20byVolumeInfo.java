...
public class GatherTop20byVolumeInfo extends AsyncTask<Void, Void, Void>{
    int counter = 0;
    ...
    private String fav = "";
    GatherTop20byVolumeInfo(ArrayList<Company> companyList, Context context, ListAdapter adapter, ListView listView) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            try {
                company = Jsoup.connect("https://dsebd.org/latest_share_price_all_by_volume.php").get();
